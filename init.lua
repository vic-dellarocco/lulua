...
--Uncomment these if you want to run the debugger.lua tests:
-- package.path=package.path..package.base.."debug/?.lua;"
-- package.path=package.path..package.base.."debug/test/?.lua;"
