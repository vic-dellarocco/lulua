...
--[[In order to work from the Lulua makefile, this file has been
	modified to be run from one directory above by adding
	"penlight/" to the beginning of all paths.
	]]
...
local doc_files = dir.getfiles(normpath "penlight/docs/", "*.css")
asserteq(doc_files, {normpath "penlight/docs/ldoc_fixed.css"})

local all_doc_files = dir.getallfiles(normpath "penlight/docs/", "*.css")
asserteq(all_doc_files, {normpath "penlight/docs/ldoc_fixed.css"})

local test_samples = dir.getallfiles(normpath "penlight/tests/lua")
table.sort(test_samples)
asserteq(test_samples, {
    normpath "penlight/tests/lua/animal.lua",
    normpath "penlight/tests/lua/bar.lua",
    normpath "penlight/tests/lua/foo/args.lua",
    normpath "penlight/tests/lua/mod52.lua",
    normpath "penlight/tests/lua/mymod.lua"
})
