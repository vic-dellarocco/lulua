...
--[[It won't override these lulua functions:
warning: '?.import' will not override existing symbol
warning: '?.repr' will not override existing symbol
warning: '?.curry' will not override existing symbol
]]
pl=penlight --lulua imports penlight into namespace "penlight"
import=pl.func.import
repr=pl.func.repr
curry=pl.func.curry
