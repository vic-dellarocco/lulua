...
check(simple,
    {'-o','help','-q',normpath 'penlight/tests/test-lapp.lua'},
    {quiet=true,p=false,o='help',input='<file>',input_name=normpath 'penlight/tests/test-lapp.lua'})
test.asserteq(calls, {
    {'o', 'help'},
    {'quiet', '-q'},
    {'input', normpath 'penlight/tests/test-lapp.lua'}
})
lapp.callback = nil
...
check(long_file,{'--open',normpath 'penlight/tests/test-lapp.lua'},{open='<file>',open_name=normpath 'penlight/tests/test-lapp.lua'})
