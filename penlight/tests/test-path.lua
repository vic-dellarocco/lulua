...
do
  ...
  path.chdir("penlight/docs")
  asserteq(path.currentdir(), cp .. path.sep .. "penlight/docs")
  path.chdir("../..")
  asserteq(path.currentdir(), cp)
end

-- path.isdir
asserteq( path.isdir( "penlight/docs" ), true )
asserteq( path.isdir( "penlight/docs/" ), true )
asserteq( path.isdir( "penlight/docs/index.html" ), false )
asserteq( path.isdir( path.currentdir() ), true)
asserteq( path.isdir( "c:\\" ), path.is_windows )
asserteq( path.isdir( "c:/" ), path.is_windows )

-- path.isfile
asserteq( path.isfile( "penlight/docs" ), false )
asserteq( path.isfile( "penlight/docs/index.html" ), true )

-- path.exists
asserteq( path.exists( "penlight/docs"), "penlight/docs")
asserteq( path.exists( "penlight/docs/index.html"), "penlight/docs/index.html")
