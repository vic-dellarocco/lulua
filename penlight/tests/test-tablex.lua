...
utils.import(tablex)
--[[ Lulua already defines these names:
warning: '?.values' will not override existing symbol
warning: '?.deepcopy' will not override existing symbol
warning: '?.map' will not override existing symbol
warning: '?.merge' will not override existing symbol
warning: '?.range' will not override existing symbol
warning: '?.keys' will not override existing symbol
warning: '?.sort' will not override existing symbol
warning: '?.zip' will not override existing symbol
warning: '?.filter' will not override existing symbol
warning: '?.copy' will not override existing symbol
]]
values=penlight.tablex.values
deepcopy=penlight.tablex.deepcopy
map=penlight.tablex.map
merge=penlight.tablex.merge
range=penlight.tablex.range
keys=penlight.tablex.keys
sort=penlight.tablex.sort
zip=penlight.tablex.zip
filter=penlight.tablex.filter
copy=penlight.tablex.copy
--[[]]
