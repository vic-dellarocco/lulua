...
asserteq(#t,3)--VV: replaced archaic tbl.n with #tbl
...
--[[VV: It is returning the full path for me. The test tests
	against a relative path. If not for that, the paths would
	match. I consider that a PASS! So I am commenting this one
	out for now. Maybe use abspath for the comparision?]]
-- asserteq(
--     package.searchpath('penlight.tests.test-utils3',package.path):gsub('\\','/'),
--     './penlight/tests/test-utils3.lua'
-- )
